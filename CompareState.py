import pandas as pd
import sys
arp_before = 'reports/keyArp-baseline.csv'
arp_after = 'reports/arp-key-October-29_20-02.csv'

route_before = "reports/keystoneRoute-baseline.csv"
route_after = "reports/routes-key-October-29_20-02.csv"
